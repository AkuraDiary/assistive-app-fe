...
const activeCourse = computed(() =>
  activeCourseId.value
    ? props.courses.find((c) => c.id === activeCourseId.value) ?? null
    : null,
)
...
.course-panel__select:hover { border-color: #3caa78; }
.course-panel__select:focus { border-color: #3caa78; box-shadow: 0 0 0 3px rgba(60,170,120,0.15); }
