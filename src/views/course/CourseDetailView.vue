    ...
    <template v-else-if="courseDetail">
      ...
      <div class="cdv-page__header-actions">
        <CourseDetailHeader :course="courseDetail">
          <template #actions v-if="isEditMode">
            <button class="cdv-btn cdv-btn--primary" style="border-radius: 999px;">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            <button
              class="cdv-btn cdv-btn--outline"
              style="border-radius: 999px; background: transparent; border: 1px solid var(--color-primary); color: var(--color-primary);"
