export const ui = {
  ...
  variants: {
    primary: {
      solid:
        'bg-primary text-white hover:brightness-95 focus:ring-[#FFB3D1]',

      outline:
        'border border-primary text-primary bg-white hover:bg-[#FFF0F6]',

      ghost:
        'text-primary hover:bg-[#FFF0F6]',

      input:
        'focus:border-primary focus:ring-[#FFB3D1]/40',
    },
